...
#define UE_PROJECT_NAME Steamwell
#define UE_TARGET_NAME SteamwellEditor
#define UE_MODULE_NAME "SteamwellEditor"
...
#define STEAMWELLEDITOR_API DLLEXPORT
#define ENHANCEDINPUT_API DLLIMPORT
#define STEAMWELL_API DLLIMPORT
